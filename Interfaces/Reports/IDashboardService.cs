...
public interface IDashboardService
{
    ...
    Task<AnalyticsSummaryDto> GetAnalyticsSummaryAsync(int? branchId = null, OrderSource? source = null);
    Task<byte[]> ExportSalesToCsvAsync(DateTime? from, DateTime? to, OrderSource? source = null, int? branchId = null);
    Task<AdvancedDashboardStatsDto> GetAdvancedStatsAsync(int? branchId = null, OrderSource? source = null);
